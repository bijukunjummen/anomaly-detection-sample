 ...
 * 
 */
public class AnomalyDetectionBasedOnGaussianDistribution {

    //99 Percentile values for the last 5 mins collected every 15 seconds
    private List<Long> latency_data = Arrays.asList(
            10L, 15L, 9L, 7L,
            35L, 5L, 10L, 15L,
            12L, 13L, 20L, 14L,
            34L, 24L, 22L, 11L,
    ...
    public void testAnamolyDetection() {
        ...
        Tuple2<Double, Double> meanAndVariance = calculateMeanAndVarianceOfData(latency_data);
